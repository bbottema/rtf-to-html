...
public class ClassicRtfToHtmlConverterTest {

	@Test
	public void testSimpleConversion() {
		String html = ClassicRtfToHtmlConverter.INSTANCE.toHtml(classpathFileToString("test-messages/input/simple-test.rtf"));
	...
	public void testComplexRtfConversion() {
		String html = ClassicRtfToHtmlConverter.INSTANCE.toHtml(classpathFileToString("test-messages/input/complex-test.rtf"));
	...
	public void testChineseRtfConversion() {
		String html = ClassicRtfToHtmlConverter.INSTANCE.toHtml(classpathFileToString("test-messages/input/chinese-exotic-test.rtf"));
	...
	public void testUnicodeRtfConversion() {
		String html = ClassicRtfToHtmlConverter.INSTANCE.toHtml(classpathFileToString("test-messages/input/unicode-test.rtf"));
	...
	public void testNewlinesConversion() {
		String html = ClassicRtfToHtmlConverter.INSTANCE.toHtml(classpathFileToString("test-messages/input/newlines-test.rtf"));
